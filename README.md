...
| :--- | :--- | :---: |
| **Laboratório de Classificação Visual** | Treinamento de modelo de visão computacional focado na identificação de vieses algorítmicos e análise de impactos sociais. | [Ver Projeto](file:///C:/Users/mastu/Downloads/Document.pdf) |
...
| **Desenvolvimento de MVP+** | Evolução de protótipo para produto autoral com integração Firebase, design personalizado e implementação de novos recursos funcionais. | [Ver Projeto]([./projeto-do-clone-ao-produto-minimo-viavel-mvp/)](https://gustavo-matsuo.github.io/velocdrive-car-rental-system/) |
